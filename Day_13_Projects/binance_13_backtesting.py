######## BACKTESTING with backtrader 2024 (Binance Version)
...
def fetch_binance_data(symbol='BTCUSDT', timeframe='1d', fromdate=datetime(2017,1,6), todate=datetime(2022,5,4)):
