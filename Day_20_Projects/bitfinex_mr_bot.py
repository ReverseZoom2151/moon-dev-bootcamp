#!/usr/bin/env python3
"""
Mean Reversion Trading Bot for Bitfinex.
"""
...
from Day_12_Projects.bitfinex_nice_funcs import *
...
SYMBOLS = ['WIF:USDT', 'POPCAT:USDT']
SYMBOLS_DATA = {
    'WIF:USDT': {'sma_period': 14, 'buy_range': (14, 15), 'sell_range': (14, 22)},
    'POPCAT:USDT': {'sma_period': 14, 'buy_range': (12, 13), 'sell_range': (14, 18)}
}
