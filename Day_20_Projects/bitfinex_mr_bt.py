#!/usr/bin/env python3
"""
Mean Reversion Strategy Backtesting Script (Bitfinex Version)
"""
...
from Day_12_Projects.bitfinex_nice_funcs import create_exchange, get_ohlcv2, process_data_to_df
...
def fetch_and_prepare_data(symbol='WIF:USDT', timeframe='1h', lookback_days=365):
