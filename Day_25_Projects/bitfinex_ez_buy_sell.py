...
try:
    from Day_12_Projects.bitfinex_nice_funcs import get_position, token_price, market_buy, market_sell
except ImportError:
    print('Error: bitfinex_nice_funcs.py not found.')
    exit()
    ...
    while True:
        ...
        try:
            if pos > 0:
                ...
                market_buy(symbol, chunk_usd, slippage)
...
def main():
    print('=' * 20)
    print(colored(' Bitfinex Manual Buy/Close Tool', 'cyan', attrs=['bold']))
    print('=' * 20)
